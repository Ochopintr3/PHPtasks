...
<body>
    <header>
        <div>
            <form method="post">
                <input type="text" name="folder_name" placeholder="Folder Name"> - <button class='submit' type="submit">Create Folder</button>
                <span><?=$err1?></span>
            </form>
        </div>
        <div>
            <form method="post">
                <input type="text" name="file_name" placeholder="File Name"> - <button class='submit' type="submit">Create File</button>
                <span><?=$err2?></span>
            </form>
        </div>
    </header>
